...
from common_func import extract_json_string
...
def run():
    if authenticate_user():
        ...
        st.markdown("This app is a demo app for deploying to productinise ML model.")
        ...
        inference_input = {"instances": [list(data.values())]}
